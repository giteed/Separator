...
Вот обновленное оглавление с добавленной ссылкой на `prompt_toolkit_menu.md` в разделе **Дополнительные документы**.
...
Теперь ссылка на `docs/prompt_toolkit_menu.md` находится в разделе **Дополнительные документы**.
